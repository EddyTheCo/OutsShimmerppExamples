        ...
        QObject::connect(info,&Node_info::finished,&a,[=,&a]( ){
            ...
            QObject::connect(node_outputs_,&Node_outputs::finished,iota_client,[=,&a]( ){
                ...
                if(addr_bundle->amount)
                {
                    ...
                    // In a basic Basic Output an Address Unlock Condition must be present https://wiki.iota.org/shimmer/tips/tips/TIP-0018/#additional-transaction-syntactic-validation-rules
                    ...
                    const auto storDepo=Client::get_deposit(BaOut,info);
                    ...
                    if(addr_bundle->amount>=storDepo)
                    {
                        ...
                        // Add the Basic Output to the container
